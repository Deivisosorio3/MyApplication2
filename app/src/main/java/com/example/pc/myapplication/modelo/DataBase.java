...
public class DataBase extends SQLiteOpenHelper{
        ...
        String crearTablaMascota="create table "+ Constantes.NOMBRE_TABLA_MASCOTAS+" ("+
                Constantes.COLUMNA_CEDULA_MASCOTA+" text , "+
                Constantes.COLUMNA_NOMBRE_MASCOTA+" text,"+
                Constantes.COLUMNA_TIPO_MASCOTA+" text, "+
                Constantes.COLUMNA_EDAD_MASCOTA+" long,"+
